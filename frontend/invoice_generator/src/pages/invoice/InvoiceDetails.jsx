...
useEffect(() => {
  const fetchInvoice = async () => {
    try {
      ...
      setInvoice(response.data); // ✅ Correct mapping
    } catch (error) {
          ...
          >
            <div className='flex flex-col sm:flex-row justify-between items-start pb-8 border-b border-slate-200'>
              ...
              <div className='text-left sm:text-right mt-4 sm:mt-0'>
                ...
                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                  invoice.status === 'Paid' ? 'bg-emerald-100 text-emarald-800' :
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-8 my-8'>
                ...
                <div className='sm:text-right'>
                  <h3 className='text-sm font-semibold text-slate-500 uppercase tracking-wider mb-3'>BillTo</h3>
