...
const DashboardLayout = ({children,activeMenu}) => {
  ...
  //close dropdwons when clicking outside
  useEffect(()=>{
  ...
  return (
    ...
    >
      {/*Company Logo*/} 
      <div className="flex items-center h-16 border-gray-200 px-6">
        <Link className="flex items-center space-x-3" to="/dashboard">
          <div className="h-8 w-8 bg-gradient-to-br from-blue-900 to-blue-700 rounded flex items-center justify-center">
