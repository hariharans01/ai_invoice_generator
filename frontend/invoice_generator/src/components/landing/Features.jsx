...
const Features = () => {
  return (
    <section id="features" className="py-20 lg:py-28 bg-gray-50">
        <div className="max-w-7xl mx-xuto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
                <h2 className="text-3xl xm:text-4xl font-extrabold text-gray-900 mb-4">Powerful Features to Run Your Business</h2>
