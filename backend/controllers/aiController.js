...
const generateReminderEmail  = async (req,res) => {
    ...
    try{
       ...
       const prompt =`
       You are a professional and polite accounting assistance. write a friendly reminder email to a client about an overview or upcoming invoice payment.
...
const getDashboardSummary = async (req,res) => {
    ...
    try{
        ...
        const prompt = `
            ...
            For example, if there is a high outsatnding amount, suggest sending reminders. If revenue is high, be encouraging
